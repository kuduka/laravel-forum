...
<div class="card" v-if="editing">
    ...
    <div class="card-footer">
        <div class="level">
            <button class="btn btn-primary btn-sm level-item" @click="editing = true" v-show="! editing">Edit</button>
            <button class="btn btn-primary btn-sm level-item" @click="update">Update</button>
            <button class="btn btn-danger btn-sm level-item" @click="resetForm">Cancel</button>
...
<div class="card" v-else>
    ...
    <div class="card-footer" v-if="authorize('owns', thread)">
        <button class="btn btn-primary btn-sm level-item" @click="editing = true">Edit</button>
    </div>
</div> 